            ...
            if bill_table:
                ...
                for i in range(1,numberOfTr):
                    ...
                    if billNumber not in billsRaw:
                        ...
                        #https://www.govtrack.us/data/congress/106/bills/hr/hr2366/data.json
                        #https://www.congress.gov/bill/106th-congress/senate-bill/353/all-info
                        ...
                        try:
                            url = "https://www.congress.gov/bill/"+billCongressNumber+"th-congress/"+chamber+"-bill/"+getNumber+"/all-info"
                            #requests
                            url_r = requests.get(url)
                            #run the requests through soup
                            url_soup = BeautifulSoup(url_r.content, "html.parser")
                            ...
                            representing = (sponsor.split(start))[1].split(end)[0]
                            representing = representing.split("-")

                            #get status
                            status = overview.find("ol",{"class":"bill_progress"})
                        ...
                        try:
                            ...
                            pass
                        try:
                            sponsorObj["first_name"] = sponsorData["results"][0]["first_name"]
                        except:
                            sponsorObj["first_name"] = words[2]
                            pass
                        try:
                            sponsorObj["last_name"] = sponsorData["results"][0]["last_name"]
                        except:
                            sponsorObj["last_name"] = words[1]
                            pass
                        try:
                            sponsorObj["chamber"] = sponsorData["results"][0]["chamber"]
                        except:
                            pass
                        try:
                            sponsorObj["in_office"] = sponsorData["results"][0]["in_office"]
                        except:
                            pass
                        try:
                            sponsorObj["party"] = sponsorData["results"][0]["party"]
                        except:
                            sponsorObj["party"] = representing[0]
                            pass
                        try:
                            sponsorObj["state"] = sponsorData["results"][0]["state"]
                        except:
                            sponsorObj["state"] = representing[1]
                            pass
                        try:
                            sponsorObj["state_name"] = sponsorData["results"][0]["state_name"]
                        except:
                            pass
                        try:
                            sponsorObj["title"] = sponsorData["results"][0]["title"]
                        except:
                            sponsorObj["title"] = words[0]
                            pass
                        try:
                            sponsorObj["facebook_id"] = sponsorData["results"][0]["facebook_id"]
                        except:
                            pass
                        try:
                            sponsorObj["twitter_id"] = sponsorData["results"][0]["twitter_id"]
                        except:
                            pass
                        try:
                            sponsorObj["website"] = sponsorData["results"][0]["website"]
                        except:
                            pass
                        try:
                            sponsorObj["youtube_id"] = sponsorData["results"][0]["youtube_id"]
                        except:
                            pass
                        ...
                        bills[billNumber]["official-title"] = data["official_title"]
                        ...
                        bills[billNumber]["subjects-top-term"] = data["subjects_top_term"]
                        bills[billNumber]["title"] = data["titles"][0]["title"]
                        try:
                            bills[billNumber]["purpose"] = data["titles"][1]["title"]
                        except:
                            bills[billNumber]["purpose"] = data["titles"][0]["title"]
